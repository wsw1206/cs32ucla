...
#ifndef __HW1__newSequence__
#define __HW1__newSequence__
...
public:
    Sequence();
    Sequence(int siz);    // Create an empty sequence.
    ...
    //newSequence operator=(const newSequence &other);
private:
    ItemType *m_list;
    int m_size;
    int maxsize;
...
#endif /* defined(__HW1__newSequence__) */
